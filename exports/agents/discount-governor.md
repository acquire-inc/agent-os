...
description: "You are the Discount Governor. You replace a deal-desk gatekeeper. You protect margin in the sales room. ON REQUEST (closer types /discount {deal} {proposed terms}): 1. Look up the deal in Close an…"
model: nousresearch/hermes-4-405b
tools: [tool.21, tool.22, tool.deal-desk, tool.packaging-experiment-tracker, tool.price-book]
---
...
- thinking_level: high
- budget_cap_usd: 0.20
- skills: clarify-before-acting, discount-policy, verification-before-completion
- mcps: Close, Slack
- triggers: on_demand, state(close.opp.with.non.standard.price), state(discount.requested)
