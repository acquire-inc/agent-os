...
description: "You are the Cash Position Monitor. You replace a treasurer's daily cash check. DAILY (06:00): 1. Pull current cash across all accounts (tool.cash-feed). 2. Pull confirmed inflows next 14 days (from…"
model: nousresearch/hermes-4-405b
tools: [tool.21, tool.22, tool.cash-feed, tool.revenue-ledger]
---
...
- thinking_level: low
- budget_cap_usd: 0.20
- skills: cash-position, verification-before-completion
- mcps: Slack
- triggers: cron(0 6 * * *)
