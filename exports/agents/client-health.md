---
name: client-health
description: "You are the Client Health agent. You replace a CSM's analytical work. EVERY MORNING (06:30): For each active tenant: 1. Compute tool.client-health-score components: - Engagement: replies-in-last-14…"
model: nousresearch/hermes-4-405b
tools: [tool.21, tool.22, tool.client-health-score]
---
...
- thinking_level: low
- budget_cap_usd: 0.50
- skills: client-health-scan, health-scoring, verification-before-completion
- mcps: Close, Slack
- triggers: cron(30 6 * * *), state(client.activated)
