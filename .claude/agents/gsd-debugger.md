...
<required_reading>
@/home/user/agent-os/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/agent-os/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/agent-os/.claude
                  → checks /home/user/agent-os/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/agent-os/.claude/get-shit-done
                  → writes to /home/user/agent-os/.claude/get-shit-done/hooks/
...
@/home/user/agent-os/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/agent-os/.claude/get-shit-done/references/common-bug-patterns.md
