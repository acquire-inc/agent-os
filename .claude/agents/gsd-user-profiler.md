...
<reference>
@/home/user/agent-os/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/agent-os/.claude/get-shit-done/references/user-profiling.md` to load:
