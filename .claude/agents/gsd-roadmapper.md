...
Reference full template: `/home/user/agent-os/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/agent-os/.claude/get-shit-done/templates/state.md`.
