...
Use template from `/home/user/agent-os/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/agent-os/.claude/get-shit-done/templates/UI-SPEC.md`
