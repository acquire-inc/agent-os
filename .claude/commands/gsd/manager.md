...
<execution_context>
@/home/user/agent-os/.claude/get-shit-done/workflows/manager.md
...
Read and execute `/home/user/agent-os/.claude/get-shit-done/workflows/analyze-dependencies.md` end-to-end.
