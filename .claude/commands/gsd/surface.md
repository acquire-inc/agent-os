...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/agent-os/.claude/.gsd-surface.json`
(sibling to `/home/user/agent-os/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/agent-os/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/agent-os/.claude/skills`).
...
`/home/user/agent-os/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/agent-os/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/agent-os/.claude/.gsd-surface.json`
Install profile marker: `/home/user/agent-os/.claude/.gsd-profile`
Skill dirs: `/home/user/agent-os/.claude/skills/gsd-*/`
Engine module: `/home/user/agent-os/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/user/agent-os/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
