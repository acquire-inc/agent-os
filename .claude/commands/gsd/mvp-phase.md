...
<execution_context>
@/home/user/agent-os/.claude/get-shit-done/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @/home/user/agent-os/.claude/get-shit-done/workflows/mvp-phase.md end-to-end.
