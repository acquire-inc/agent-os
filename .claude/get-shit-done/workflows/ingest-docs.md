...
```bash
INIT=$(node "/home/user/agent-os/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/user/agent-os/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
