...
```markdown
Read /home/user/agent-os/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/agent-os/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/agent-os/.claude/agents/gsd-ui-checker.md for instructions.
