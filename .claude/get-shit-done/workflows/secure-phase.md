...
```
Agent(
  prompt="Read /home/user/agent-os/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/agent-os/.claude/get-shit-done/templates/SECURITY.md`
